...
import ErrorModal from "../components/ErrorModal"; // Aseg�rate de tener esta importaci�n
...
export default function NuevoUsuarioModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Convertir email vac�o a null antes de enviar
      const dataToSend = {
        ...form,
      ...
      // Mostrar el modal de �xito solo despu�s de la creaci�n exitosa
      setSuccessModal({
        show: true,
        message: "Usuario creado exitosamente.",
      });
      await onUsuarioCreado();
      setIsSubmitting(false); // Puedes desactivar el bot�n de "crear" aqu� tambi�n
    } catch (error: any) {
      setErrors((prev) => ({
        ...prev,
  ...
  const handleSuccessModalClose = () => {
    ...
    onClose(); // Cierra el modal principal despu�s de aceptar el SuccessModal
  };
