-- ============================================
-- Script de SEEDS para PostgreSQL (Supabase)
-- ============================================
-- IMPORTANTE: Ejecuta este script en el SQL Editor de Supabase
-- después de que las tablas se hayan creado automáticamente
...
TRUNCATE TABLE turno_producto CASCADE;
TRUNCATE TABLE factura_detalle CASCADE;
...
-- Configurar el SEQUENCE de productos para que comience en 10000
...
-- Contraseña por defecto para todos: "trimly2025"
INSERT INTO usuario (username, password, nombre, apellido, email, rol, activo, "fechaCreacion") VALUES
('admin.trimly', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Administrador', 'Sistema', 'admin@trimly.com', 'admin', true, NOW()),
('maria.peluquera', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'María', 'Rodríguez', 'maria@trimly.com', 'empleado', true, NOW()),
('carlos.estilista', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Carlos', 'Mendez', 'carlos@trimly.com', 'empleado', true, NOW()),
('sofia.colorista', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Sofía', 'Blanco', 'sofia@trimly.com', 'empleado', true, NOW()),
('lucia.manicura', '$2b$10$EixZaYVK1fsbw1ZfbX3OXePaWxn96p36WQoeG6Lruj3vjPGga31lW', 'Lucía', 'Herrera', 'lucia@trimly.com', 'empleado', true, NOW());
...
SELECT 'Clientes insertados:' as tabla, COUNT(*) as cantidad FROM cliente
UNION ALL
